...
const translations: Translations = {
  en: {
    ...
    "about.story.p3": "The firm operates across all primary areas of law, providing legal advisory services and courtroom representation to individuals and businesses. We approach every case with attention to detail, confidentiality and clear strategic planning, aiming to achieve the best possible outcomes.",
    "about.story.cta": "Meet the Team",
    "about.founder.name": "Andreas Polycarpou",
    "about.founder.role": "Founder, Managing Director & Lawyer",
  ...
  el: {
    ...
    "about.story.title": "Η ΙΣΤΟΡΙΑ ΜΑΣ",
