...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "about.story.p1": "Andreas Polycarpou & Co LLC was established in 2009 by Andreas Polycarpou with a single conviction: that clients deserve boutique-quality legal counsel without the impersonal experience of a large firm.",
    ...
    "team.join.desc": "Andreas Polycarpou & Co LLC offers a collaborative, intellectually stimulating environment for attorneys who are passionate about delivering the best outcomes for their clients.",
  ...
  el: {
    ...
    // Home Hero
    "home.hero.eyebrow": "Κύπρος · Ιδρύθηκε το 2009",
    ...
    // Why choose us
    "why.eyebrow": "Γιατί Andreas Polycarpou & Co LLC",
    ...
    "about.header.title": "Σχετικά με την Andreas Polycarpou & Co LLC",
    "about.story.eyebrow": "Η Ιστορία Μας",
    "about.story.title": "Θεμελιωμένο σε Αρχές. Χτισμένο για Αποτελέσματα.",
    "about.story.p1": "Η Andreas Polycarpou & Co LLC ιδρύθηκε το 2009 από τον Ανδρέα Πολυκάρπου με πεποίθηση ότι οι πελάτες αξίζουν νομική συμβουλευτική υψηλής ποιότητας.",
    ...
    "team.join.desc": "Η Andreas Polycarpou & Co LLC προσφέρει ένα συνεργατικό, πνευματικά διεγερτικό περιβάλλον.",
    ...
    "footer.hours": "Ωράριο",
    "footer.copyright": "Andreas Polycarpou & Co LLC. Όλα τα δικαιώματα κατοχυρωμένα.",
