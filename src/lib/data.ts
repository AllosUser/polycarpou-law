...
export const team = [
  {
    ...
    role: {
      ...
      el: "Ιδρυτής & Διευθύνων Σύμβουλος"
    },
  ...
  },
  {
    ...
    image: josephinPhoto,
    bio: {
      en: "Josephin Solomou graduated from the Law Department of the Democritus University of Thrace. She joined the firm as a lawyer in September 2025. At the same time, she is pursuing her LL.M. in International Commercial Law at European University Cyprus.\n\nShe handles matters across various areas of law according to the needs of the firm and is committed to providing diligent and reliable legal services.\n\nJosephin approaches her work with professionalism and a strong dedication to continuous learning and development.",
      el: "Η Τζιόζεφιν Σολωμού αποφοίτησε από το τμήμα Νομικής του Δημοκρίτειου Πανεπιστημίου Θράκης. Εντάχθηκε στο γραφείο μας ως δικηγόρος τον Σεπτέμβριο του 2025. Παράλληλα, συνεχίζει τις σπουδές της για την απόκτηση μεταπτυχιακού τίτλου (LL.M.) στο Διεθνές Εμπορικό Δίκαιο στο Ευρωπαϊκό Πανεπιστήμιο Κύπρου.\n\nΑσχολείται με υποθέσεις που καλύπτουν διάφορους τομείς του δικαίου σύμφωνα με τις ανάγκες του γραφείου και δεσμεύεται να παρέχει επιμελείς και αξιόπιστες νομικές υπηρεσίες.\n\nΑντιμετωπίζει την εργασία της με επαγγελματισμό και ισχυρή προσήλωση στη συνεχή μάθηση και εξέλιξη."
    },
    education: {
  ...
  },
  {
    ...
    role: {
      en: "Associate Lawyer",
      el: "Συνεργάτης Δικηγόρος"
    },
    image: mariantinaPhoto,
    bio: {
      en: "Mariantina Koutsogeorgopoulou graduated in 2014 from the Department of Political Science and International Relations of the University of the Peloponnese. She subsequently pursued her legal studies at the School of Law of the European University Cyprus, from which she graduated in 2017.\n\nShe completed her legal traineeship at the Law Office of the Republic of Cyprus, which concluded in October 2018. In November 2018, she joined the law firm as an Associate Lawyer.\n\nHer practice focuses primarily on the drafting and review of employment contracts, providing legal support on matters related to labour law.",
      el: "Η Μαριαντίνα Κουτσογεωργοπούλου αποφοίτησε το 2014 από το τμήμα Πολιτικής Επιστήμης και Διεθνών Σχέσεων του Πανεπιστημίου Πελοποννήσου. Εν συνέχεια ακολούθησε νομικές σπουδές στη Νομική Σχολή του Ευρωπαϊκού Πανεπιστημίου Κύπρου, από όπου και αποφοίτησε το 2017.\n\nΟλοκλήρωσε την άσκηση της στη Νομική Υπηρεσία της Δημοκρατίας, η οποία περατώθηκε τον Οκτώβριο του 2018. Τον Νοέμβριο του 2018 εντάχθηκε στο δικηγορικό γραφείο ως Συνεργάτης Δικηγόρος.\n\nΑσχολείται κυρίως με τη σύνταξη και εξέταση συμβολαίων εργασίας, παρέχοντας νομική υποστήριξη σε θέματα που άπτονται του εργατικού δικαίου."
    },
    education: {
  ...
  },
  {
    ...
    bio: {
      en: [
        "Joined our Law Firm in May 2026.",
        "She has a secretarial role, undertaking the coordination of daily operations, communication with clients, and the management of office support.",
      ...
      el: [
        "Εντάχθηκε στη Δικηγορική μας Εταιρία το Μάιο του 2026.",
